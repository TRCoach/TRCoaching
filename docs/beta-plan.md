...
1. **Control plane (this repo)** — lifecycle, schemas, dry-run adapters, fail-closed engine, benchmark QA.
...
6. **Founder-gated first client** — go-live, assignment, and any refund/credit stay manual.
