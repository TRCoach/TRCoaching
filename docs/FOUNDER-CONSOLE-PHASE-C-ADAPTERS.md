...
| Slack `#ai-ops` | yes | fake transport | no | no | code-ready, not live | NOT_CONNECTED |
...
- Slack rehearsal: `SLACK_DISPATCH_ENABLED=1`, `SLACK_BOT_TOKEN`, `SLACK_AI_OPS_CHANNEL=#ai-ops` or `C…`.
